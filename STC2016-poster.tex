...
% 				  \cite{anisimov:74} (see right)
			...
			\item electron-hole pairs and phonons both couple to adsorbed molecule	  
		  \end{itemize}
		}
...
% 		\end{itemize}
  ...
  \block{}{
	...
	\begin{itemize}
	  ...
	  \item employ better electonic friction (beyond LDFA)
	  \item enhance 2TM with electron-electron-scattering 
	  \item simulate other coverages (here only 0.25ML) 
