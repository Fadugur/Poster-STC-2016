...
% 				  \item Fermi-Dirac schon hier?
			  ...
			  \item electrons transfer part of energy to ion lattice, via \raisebox{-.19\baselineskip}{\includegraphics[height=.8\baselineskip]{abb/one.png}}
		    ...
		    \begin{minipage}[t]{.66\colwidth}
		      ...
		      \begin{minipage}[t]{.46\colwidth}
				\begin{itemize}
				  ...
				  \item downside: surface atoms frozen $\Rightarrow$ no phonons
				\end{itemize}
		      \end{minipage}
		    \end{minipage}
		    \begin{adjustbox}{valign=t}
...
% 				\includegraphics[width=.15\colwidth]{abb/Part1SurfScheme.png}\\[.3\baselineskip]
				\hspace*{-2cm}\includegraphics[width=.38\colwidth]{abb/2TM_equs.png}
		      \end{minipage}
			\end{adjustbox}
  ...
  \block{}{
    \begin{multicols}{2}
      \begin{thebibliography}{X}
		...
		\bibitem{juaristi:08}
		J. I. Juaristi, M. Alducin, R. Díez Muiño, et al., \emph{Phys. Rev. Lett.} \textbf{100}, 116102 (2008).
