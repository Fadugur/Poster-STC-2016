...
~
		  ...
		  \innerblock{How FL-irradiation affects metal surfaces}{
...
% 			    consist of an
				  ...
				  \item visible light is absorbed by the electrons only
						  % \vbox syntax?
				  \item energy is transferred to ion lattice, via \includegraphics[height=.8\baselineskip]{abb/one.png}
				  \hspace{-0.7cm} \textbf{\color{innerblocktitlebgcolor!80!orange}electron-phonon coupling},  to ion lattice (phonons = lattice vibrations)
...
% 				  \item can be described with the Two-Temperature Model (TTM)
		    ...
		    \end{adjustbox}
			 \begin{itemize}
				\item can be simulated with Two-Temperature Model (TTM) \cite{anisimov:74}%consisting of two differential Equations 
			 \end{itemize}
		  }
