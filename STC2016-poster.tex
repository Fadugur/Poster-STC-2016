...
% 			  \includegraphics[width=.65\colwidth]{abb/Langevin_eq.png}
  ...
  \begin{columns}
  \column{.6}
  \block[titleoffsety=3cm,bodyoffsety=3cm,titleoffsetx=-.12\colwidth,titlewidthscale=.62,]{Results}{
	\begin{adjustbox}{valign=t}
	\begin{minipage}[t]{.46\colwidth}
...
% 		  \item 
% 		\end{itemize}
		\includegraphics[width=.25\colwidth]{abb/fig_8.png}
	  }	  
	\end{minipage}
	\end{adjustbox}
	\hspace*{.01\colwidth}
	\begin{adjustbox}{valign=t}
	  \begin{minipage}[t]{.47\colwidth}
	  	\innerblock{Diffusion}{
		  \includegraphics[width=.25\colwidth]{abb/Trajektorie.png}
		}	    
	  \end{minipage}
	\end{adjustbox}	  
  }
...
% 		J. I. Juaristi, M. Alducin, R. Díez Muiño, H. F. Busnengo and A. Salin, 
		...
		\bibitem{busnengo:05}
		H.F. Busnengo, M.A. Di Césare, W. Dong et al.,
