		  ...
		  \innerblock{Two-Temperature Model (2TM)\cite{anisimov:74}}{
			\begin{adjustbox}{valign=t}
			  \begin{minipage}[t]{.2\colwidth}
				\includegraphics[width=.2\colwidth]{abb/Part1SurfScheme.png}
% 				\includegraphics[width=.3\colwidth]{abb/2TM_equs.png}
		      \end{minipage}
			\end{adjustbox}
			\begin{minipage}[t]{.8\colwidth}
			  \begin{itemize}
				\item describes interaction of metal with laser, using two differential equations:%\\[-.9\baselineskip]
